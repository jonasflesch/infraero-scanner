...
@XmlRootElement(name = "ConsultarVoosNumero")
public class ConsultarVoosNumero {
    ...
    @XmlElementRef(name = "numeroVoo", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> numeroVoo;
     ...
     *     
     */
    public JAXBElement<String> getNumeroVoo() {
        return numeroVoo;
    }
     ...
     *     
     */
    public void setNumeroVoo(JAXBElement<String> value) {
